...
namespace CursusHonorum.Tests.Runtime
{
    public class EventBusTests
    {
        ...
        public void HistoryRespectsConfiguredCapacity()
        {
            ...
            Assert.That(((OnNewDayEvent)eventBus.History[0]).Day, Is.EqualTo(16));
            Assert.That(((OnNewDayEvent)eventBus.History[eventBus.History.Count - 1]).Day, Is.EqualTo(20));
        }
        ...
        public void HistoryCanBeDisabled()
        {
            ...
            Assert.That(((OnNewDayEvent)eventBus.History[0]).Day, Is.EqualTo(3));
        }
    }
}
